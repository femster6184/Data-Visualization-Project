...
//import Data
    var wData = [[],[],[],[],[]]
        ...
        wData[0].push(Object.values(data.country))
        wData[1].push(Object.values(data.location_name))
        wData[2].push(Object.values(data.air_quality))
        wData[3].push(Object.values(data.latitude))
        wData[4].push(Object.values(data.longitude))
